       ...
       <div className="bg-[#F6F5FF]">
        ...
        <div className='lg:container lg:px-[1.3rem] flex justify-center lg:mt-28 mt-12 mb-12 lg:mb-28'>
                <div className='shadow-primary w-[550px] lg:p-12 p-3'> 
                        ...
                        <button className='w-full bg-pink text-white text-[14px] md:text-[17px] md:px-11 px-8 md:py-3 py-2 rounded-sm font-josefin font-medium hover:bg-[#e02977]'>Sign In</button>
